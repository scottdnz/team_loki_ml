		...
		for job in data:
			...
			if "building_data" in job["project_data"] and len(job["project_data"]["building_data"]) > 0:
				...
				if len(job["project_data"]["building_data"][0]["rfi_documents"]) > 0:
					...
					rfiItems = job["project_data"]["building_data"][0]["rfi_documents"][0]["rfi_items"]
					for rfiItem in rfiItems:
						rfiTopics.append(rfiItem["Title"])

			if rfiTopics:
				for singleRFItopic in rfiTopics:
					fields = {
						"job_id": jobID,
...
if __name__ == "__main__":
	dataDir = "C:/Users/marthijn.batlajeri/Projects/Activate/envhack/data/"
	# dataDir = "C:/Users/scott.davies/Documents/VBoxShared/202102/test/"
	outputDir = "C:/Users/marthijn.batlajeri/Projects/Activate/envhack/output/"
